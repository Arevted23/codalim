<script src="build/js/app.js"></script>
    <footer class="footer">
        <div>
            <img src="build/img/logoFooter.png" alt="" href="#">
        </div>
        <div>
            <h2>Redes Sociales</h2>
            <a href="https://www.facebook.com/codigoalimentario2/">
            ...
            <a href="https://twitter.com/CodigoAlimenta1">
        ...
        <div>
            ...
            <p> 5888 2887 | 5867 2683 comunicacion@codigoalimentario.com </p>
            <p>Boulevard Benito Juarez 10 Nave E-4 Col. San Mateo Cuautepec Tultitlán, Estado de México C.P. 54948</p>
        </div>
    </footer>
    </body>
